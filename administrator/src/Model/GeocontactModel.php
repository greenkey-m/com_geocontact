 ...
 * Geocontact model
 */
class GeocontactModel extends AdminModel
{
	/**
	 * @var		string	The prefix to use with controller messages
	 * @since	1.6
	 */
	protected $text_prefix = 'COM_GEOCONTACT';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_geocontact.edit.geocontact.data', array());
        ...
        foreach ($this->getForm()->getFieldset() as $field) {
            if ($field->type === 'Calendar') {
                ...
                if ($data[$field->fieldname] === '') {
                    ...
                    $phpFormat = GeocontactHelper::convertStrftimeToDateTimeFormat($format);
